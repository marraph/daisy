...
export const SwitchButton: React.FC<SwitchButtonProps> = ({ firstTitle, secondTitle, className, ...props }) => {
    ...
    return (
        <div className={cn("flex items-center rounded-lg font-semibold cursor-pointer text-gray bg-dark p-0.5 border border-white border-opacity-20 text-sm", className)} {...props}>
