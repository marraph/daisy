                ...
                <div className={cn("absolute top-full left-0 overflow-hidden", className)} ref={menuRef}>
                    <DayPicker mode={"range"}
                               ...
                               classNames={{
                                   ...
                                   day_selected:
                                       "bg-dark text-white hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
                                   day_today: "bg-selectwhite text-dark rounded-lg hover:text-black hover:bg-white",
                                   day_outside:
                                       "day-outside opacity-50 aria-selected:bg-accent/50 aria-selected:opacity-30",
                                   day_disabled: "text-muted-foreground opacity-50",
                                   day_range_middle:
                                       "aria-selected:bg-dark text-white rounded-none",
