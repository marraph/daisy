...
const Shortcut: React.FC<ShortcutProps> = ({ text, className, ...props }) => {
    return(
        <div className={cn("h-min flex items-center rounded-md border text-xs px-1 py-0.5 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.3)] dark:shadow-[inset_0_-2px_4px_rgba(0,0,0,0.6)] " +
