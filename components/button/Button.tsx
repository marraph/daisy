...
const button = cva("w-max rounded-lg font-medium text-sm py-2 px-4 flex items-center disabled:cursor-not-allowed disabled:hover:none disabled:border-none", {
      variants: {
        theme: {
          default: "bg-zinc-200 dark:bg-black-light text-zinc-700 dark:text-gray hover:text-zinc-800 dark:hover:text-white " +
                   "hover:bg-zinc-100 dark:hover:bg-dark-light border border-zinc-300 dark:border-edge disabled:text-zinc-500 " +
                   "dark:disabled:text-marcador disabled:bg-zinc-400 dark:disabled:bg-dark-light",
          primary: "bg-zinc-800 dark:bg-zinc-200 text-zinc-200 dark:text-dark hover:text-white dark:hover:text-black " +
                   "hover:bg-dark-light dark:hover:bg-zinc-100 border border-zinc-700 dark:border-white disabled:text-marcador " +
